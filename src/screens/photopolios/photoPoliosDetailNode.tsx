...
import DeletePhotoPolioNode from './deletePhotoPolios/DeletePhotopoiloNode'

function PhotoPoliosDetailNode(props: any) {
  const history = useHistory()
  const pInfo = props.location.state.pInfo
  console.log(pInfo)
  // 탭

  const [pInfoNode, setPInfoNode] = useState<any>(pInfo)
...
export default PhotoPoliosDetailNode
