...
const Edit_RN_MUTATION = gql`
  mutation EditPhotoRN(
    $id: Int!
    $file: Upload
    $file2: Upload
    $file3: Upload
...
function EditPhotoPoliosRN(props: any) {
  const { register, handleSubmit, setValue, getValues } = useForm()
  const pInfo = props.location.state.pInfoRN
  ...
  const [editPhotoNodeMutaion] = useMutation<any>(Edit_RN_MUTATION, {
    onCompleted,
  })
...
export default EditPhotoPoliosRN
