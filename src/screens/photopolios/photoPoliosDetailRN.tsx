...
import DeletePhotoPolioRN from './deletePhotoPolios/DeletePhotopoiloRN'
import ReactPlayer from 'react-player'

function PhotoPoliosDetailRN(props: any) {
  ...
  const [pInfoRN, setPInfoRN] = useState<any>(pInfo)
  return (
...
export default PhotoPoliosDetailRN
