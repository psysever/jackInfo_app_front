...
const DELETE_PHOTO_RN_MUTATION = gql`
  mutation deletePhotoRN($id: Int!) {
    deletePhotoRN(id: $id) {
      ok
      error
    }
...
export default function DeletePhotoPolioRN({ pInfo, setDelPhoto }: any) {
  //삭제후 돌아가기
  ...
  const [delPhotoCssMutaion] = useMutation<any>(DELETE_PHOTO_RN_MUTATION, {
    onCompleted,
  })
