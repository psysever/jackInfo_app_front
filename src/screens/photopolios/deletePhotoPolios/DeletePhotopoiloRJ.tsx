...
const DELETE_PHOTO_RJ_MUTATION = gql`
  mutation deletePhotoRJ($id: Int!) {
    deletePhotoRJ(id: $id) {
      ok
      error
    }
...
export default function DeletePhotoPolioRJ({
  pInfo,
  delPhoto,
  setDelPhoto,
}: any) {
  ...
  const [delPhotoRJMutaion] = useMutation<any>(DELETE_PHOTO_RJ_MUTATION, {
    onCompleted,
  })
