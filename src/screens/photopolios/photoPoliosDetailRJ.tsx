...
import DeletePhotoPolioRJ from './deletePhotoPolios/DeletePhotopoiloRJ'
import ReactPlayer from 'react-player'

function PhotoPoliosDetailRJ(props: any) {
  ...
  const [pInfoRJ, setPInfoRJ] = useState<any>(pInfo)
...
export default PhotoPoliosDetailRJ
