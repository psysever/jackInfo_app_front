...
import { PHOTO_RJ_FRAGMENT } from '../../../components/frgments'
...
const UPLOAD_RJ_MUTATION = gql`
  mutation uploadPhotoRJ(
    $file: Upload!
    $file2: Upload
    $file3: Upload
    $file4: Upload
...
function UploadFormRJ() {
  ...
  const [uploadPhotoRJMutaion] = useMutation<uploadPhoto, uploadPhotoVariables>(
    UPLOAD_RJ_MUTATION,
    {
      onCompleted,
    },
