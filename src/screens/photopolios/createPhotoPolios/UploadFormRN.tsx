...
import { PHOTO_RN_FRAGMENT } from '../../../components/frgments'
...
const UPLOAD_RN_MUTATION = gql`
  mutation uploadPhotoRN(
    $file: Upload!
    $file2: Upload
    $file3: Upload
    $file4: Upload
...
function UploadFormRN() {
  ...
  const [uploadPhotoRNMutaion] = useMutation<uploadPhoto, uploadPhotoVariables>(
    UPLOAD_RN_MUTATION,
    {
      onCompleted,
    },
